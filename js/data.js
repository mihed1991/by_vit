(function(){
  ...
  window.ByVitDefaults = {
    ...
    products: [
      {id:1,name:'100% Whey Protein',brand:'Optimum Nutrition',category:'protein',price:129,oldPrice:149,stock:15,badge:'Хит',country:'США',formType:'powder',popular:true,rating:4.9,images:['assets/product-whey.jpg'],flavors:['Шоколад','Ваниль','Клубника'],packageGroup:'optimum-whey-protein',packageOptions:[{id:'900g',label:'900 г',price:129}],shortDescription:'Сывороточный протеин для роста мышц и быстрого восстановления.',description:'Премиальный сывороточный протеин для ежедневного добора белка, восстановления после тренировок и поддержки мышечной массы.',usage:'1 порция на 250–300 мл воды или молока после тренировки либо между приемами пищи.',ingredients:'Whey Protein Isolate, Whey Protein Concentrate, какао, ароматизатор, подсластитель.'},
      {id:13,name:'100% Whey Protein',brand:'Optimum Nutrition',category:'protein',price:249,stock:15,badge:'',country:'США',formType:'powder',popular:false,rating:4.9,images:['assets/product-whey.jpg'],flavors:['Шоколад','Ваниль','Клубника'],packageGroup:'optimum-whey-protein',packageOptions:[{id:'2270g',label:'2.27 кг',price:249}],shortDescription:'Сывороточный протеин для роста мышц и быстрого восстановления.',description:'Премиальный сывороточный протеин для ежедневного добора белка, восстановления после тренировок и поддержки мышечной массы.',usage:'1 порция на 250–300 мл воды или молока после тренировки либо между приемами пищи.',ingredients:'Whey Protein Isolate, Whey Protein Concentrate, какао, ароматизатор, подсластитель.'},
    ...
    site: {
      ...
      telegram:{mode:'bot',contact:'',botToken:'',chatId:'',recoveryChatId:'',recoveryName:'',recoveryUsername:''},
      quickContact:{
        enabled:true,
      ...
      checkout:{
        ...
        blocks:{summary:true,promo:true,checkout:true,delivery:true,address:true,payment:true,comment:true}
	      ...
	      homeLayoutVersion:3,
	      homeBlocks:{
	        trust:{visible:true,order:5,eyebrow:'Почему ByVit',title:'Покупка без сюрпризов',text:'Важные условия видны до оформления заказа.',titleSize:36,textSize:15,featureOneTitle:'Понятный товар',featureOneText:'Бренд, страна, состав, фасовка и остаток указаны в карточке.',featureTwoTitle:'Удобное получение',featureTwoText:'Самовывоз, курьер, Европочта или почта по Беларуси.',featureThreeTitle:'Подтверждение заказа',featureThreeText:'Магазин уточняет детали заказа и способ оплаты до отправки.'},
	        ...
	        brands:{visible:true,order:4,eyebrow:'Бренды',title:'Оригинальные производители',text:'Быстрый выбор по брендам, которым доверяют покупатели.',titleSize:36,textSize:15,buttonText:'Все бренды',buttonUrl:'brands.html'},
